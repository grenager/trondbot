  ...
  return (
    <div className="space-y-6">
      <section className="rounded-xl border border-stone-200 bg-white p-4">
        <h2 className="text-lg font-semibold text-stone-900">{t.aboutTrondbot}</h2>
      ...
      <section className="rounded-xl border border-stone-200 bg-white p-4">
        ...
        <div className="mt-3">
          <a
            ...
            className="inline-flex w-full items-center justify-center gap-2 rounded-lg bg-stone-900 px-4 py-2.5 text-sm font-medium text-white transition-colors hover:bg-stone-800"
          >
            <svg
