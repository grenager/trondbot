...
export const es: Translations = {
  ...
  lookupSlashHint:
    "Consejo: escribe /palabra en el campo y presiona Tab para una traducción rápida.",
  lookupSlashTabHint: "para traducir",
  signIn: "Sign in",
  signOut: "Sign out",
  email: "Email",
  ...
  outOfCreditsMessage: "Te quedaste sin créditos. Abre el menú (☰) para recargar.",
  ...
  vocabSaved: "¡Guardado en tu lista de vocabulario!",
